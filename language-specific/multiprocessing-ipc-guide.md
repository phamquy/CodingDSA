# Python Inter-Process Communication (IPC): A Complete Guide
...
## Table of Contents
1. [Why IPC is Needed](#why-ipc-is-needed)
2. [Message Passing: Queue and Pipe](#message-passing-queue-and-pipe)
3. [Shared Memory: Value, Array, and SharedMemory](#shared-memory-value-array-and-sharedmemory)
4. [Manager: Shared Python Objects](#manager-shared-python-objects)
5. [Synchronization Primitives](#synchronization-primitives)
6. [fork vs. spawn: The Pickling Requirement](#fork-vs-spawn-the-pickling-requirement)
