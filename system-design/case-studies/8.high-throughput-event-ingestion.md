...
- **Exactly-once vs at-least-once**:
	- for counters used in bidding, you want *effective* correctness
...
Pros: low latency, resilient to region failure.
Cons: cross-region consistency complexity.

### Option B: Active-active ingestion, centralized log
- Regions ingest but forward to a single “home” region stream.

Pros: simpler global joins.
Cons: higher latency and dependency on the home region.
